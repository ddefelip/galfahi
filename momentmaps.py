...
def zero_moment(data, vel, vmin, vmax): 
    '''
...
def second_moment(data, vel, vmin, vmax):
    '''
    Velocity disperson map, flux-weighted square of the velocity. It is the 
    line width of the spectral line along the line of sightline, calculated within vmin and vmax. 
